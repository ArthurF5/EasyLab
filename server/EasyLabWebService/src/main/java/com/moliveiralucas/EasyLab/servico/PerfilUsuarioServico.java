...
public class PerfilUsuarioServico {
	...
	@RequestMapping(value = "/cadastrarPerfilUsuario/{perfilUsuario}",
	...
	@RequestMapping(value = "/alterarPerfilUsuario/{perfilUsuario}_{id_PerfilUsuario}",
			method = RequestMethod.GET,
			produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/consultarPerfilUsuario/{parametroBusca}",
			method = RequestMethod.GET,
			produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/excluirPerfilUsuario/{perfilUsuario}_{id_PerfilUsuario}",
			method = RequestMethod.GET,
			produces = "application/json;charset=UTF-8")
