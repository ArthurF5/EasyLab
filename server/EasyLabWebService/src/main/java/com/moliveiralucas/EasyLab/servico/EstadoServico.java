...
public class EstadoServico {
	...
	@RequestMapping(value = "/cadastrarEstado/{estado}_{uf}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/alterarEstado/{estado}_{uf}_{id_UF}", method = RequestMethod.GET,	produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/consultarEstado/{parametroBusca}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/cadastrarEstado/{estado}_{uf}_{id_UF}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
