...
public class ConvenioServico {
	...
	@RequestMapping(value = "/cadastrarConvenio/{convenio}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/alterarConvenio/{id_Convenio}_{convenio}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/excluirConvenio/{id_Convenio}_{convenio}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/consultarConvenio/{parametroBusca}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
