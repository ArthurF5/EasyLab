...
public class UsuarioServico {
	...
	@RequestMapping(value = "/cadastrarUsuario/{usuario}_{senha}_{email}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/consultarUsuario/{parametroBusca}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/alterarUsuario", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
	...
	@RequestMapping(value = "/excluirUsuario/{usuario}_{id_Usuario}", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
